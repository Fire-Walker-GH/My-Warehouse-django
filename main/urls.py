...
urlpatterns = [
    ...
    path('warehouse/delete/<int:warehouse_id>/', views.delete_warehouse, name='delete_warehouse'),
    path('warehouse/<int:warehouse_id>/add_shared_user/', views.add_shared_user_to_warehouse, name='add_shared_user'),
    path('warehouse/<int:warehouse_id>/remove_user/<int:user_id>/', views.remove_shared_user, name='remove_shared_user'),
